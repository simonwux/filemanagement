...
namespace FileManagement
{
    partial class Form1 : Form
    {
        ...
        //    int i;
        //    for (i = 1; i <= t; i++) st = st + "\t";
        //    if (t == 0) this.listBox1.Items.Add(p.name);
        //    else
        ...
        private void Print(string s)
        {
            ...
            for (int i = 0; i < s.Length; i++)
            {
                if (s[i].Equals('\n'))
                {
                    this.listBox1.Items.Add(res.ToString());
        ...
        private void PrintToTextBox(string s)
        {
        ...
        string add = "", name = "", con = "", dir = "root", comm = "";
        ...
        {
            this.controller.ProcessCommand("format");
            this.Print(this.controller.ProcessCommand("print"));
            //format();
            //print(find(dir));
        }
        ...
        {
            name = textBox2.Text;
            PrintToTextBox(this.controller.ProcessCommand("open " + name));
        ...
        {
            //this.controller.ProcessCommand("format");
            this.controller.ProcessCommand("start");
            Print(this.controller.ProcessCommand("printall"));
            //format();
            //readfile();
            //print(find(dir));
        }
        ...
        {
            this.controller.ProcessCommand("exit");
            //exitfile();
            Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            name = textBox2.Text;
            //deletefile(dir + ":" + name);
            this.controller.ProcessCommand("delete " + name);
            this.Print(this.controller.ProcessCommand("print"));
            //f1 = flag;
            //print(find(dir));
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            this.controller.ProcessCommand("write " + name + ".txt " + content);
        }
